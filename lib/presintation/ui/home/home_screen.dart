...
import 'package:magdsoftfluttertask/presintation/ui/home/di.dart';
import 'package:magdsoftfluttertask/presintation/ui/home/home_viewmodel.dart';
import 'package:magdsoftfluttertask/presintation/ui/home/product_item.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  HomeViewModel viewModel = HomeViewModel(injectProductUseCase());

  @override
  void initState() {
    super.initState();
    var brandNotifier = Provider.of<BrandSelectionNotifier>(context, listen: false);

    // Fetch products for the initially selected brand
    viewModel.getProducts(brandNotifier.selectedBrand);

    // Add a listener to the brand notifier to update products when brand changes
    brandNotifier.addListener(() {
      viewModel.getProducts(brandNotifier.selectedBrand);
    });
  }
